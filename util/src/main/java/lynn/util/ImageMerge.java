...
public class ImageMerge {
    ...
    public static void overlyingImageTest() {
        ...
        try {
            ...
            // 构建叠加层
            BufferedImage buffImg = overlyingImage(bufferImage1, bufferImage2, bufferImage1.getWidth() - bufferImage2.getWidth() - 50 , bufferImage1.getHeight() - bufferImage2.getHeight() - 50, 1.0f);
            // 输出水印图片
